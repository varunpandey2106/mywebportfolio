    ...
    <>
      ...
      <Container className="flex min-h-screen items-center justify-center">
        <div className="-mt-24 h-full max-w-2xl md:-mt-28 md:text-justify">
          ...
          <h1
            className={clsx(
              `dark:text-edge-outline-dark dark-textight z-10 bg-zinc-900 bg-clip-text font-heading 
              text-4xl tracking-widest text-white-800 text-transparent duration-1000 dark:bg-white sm:text-5xl`,
