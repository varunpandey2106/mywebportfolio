  ...
  return (
    <>
      ...
      <SimpleLayout
        ...
        intro="These are my Certifications"
      >
        <ul
          role="list"
        ...
        >
          {certificationsData.map((certification) => {
            ...
            return (
              <Card as="li" key={certification.title}>

                <h2 className="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                  <Card.Link href={certification.href}>{certification.title}</Card.Link>
                </h2>
                ...
                <p className="relative z-10 flex mt-6 text-sm font-medium transition text-zinc-400 group-hover:text-green-500 dark:text-zinc-200">
                  ...
                  <span className="ml-2">{certification.title}</span>
                </p>
              </Card>
            )
          })}
