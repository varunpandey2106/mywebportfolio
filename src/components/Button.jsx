...
const variantStyles = {
  primary:
    'bg-white font-semibold text-zinc-700 md:hover:bg-green-300 active:bg-green-400 active:text-zinc-700/70 dark:bg-zinc-900 dark:text-zinc-200 dark:md:hover:bg-green-800/70 dark:active:bg-green-900 dark:active:text-zinc-200/70',
  secondary:
